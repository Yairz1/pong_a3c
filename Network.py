...
def get_model(name):
    name2model = {'lstm': ActorCritic_lstm, 'linear': ActorCritic_linear, 'original':ActorCritic_original}
...
class ActorCritic_original(torch.nn.Module):
    def __init__(self, num_inputs, action_space):
        super(ActorCritic_original, self).__init__()
        self.conv1 = nn.Conv2d(num_inputs, 16, 4, stride=4)
